...
use Ingimarsson\SlimDataObjectsExample\RequestData\Pet\UpdatePetRequestData;
use Ingimarsson\SlimDataObjectsExample\ResponseData\GenericResponseData;
use Psr\Http\Message\ResponseInterface as Response;
use Psr\Http\Message\ServerRequestInterface as Request;

#[Path(description: "Update a pet")]
#[RequestDataClass(class: UpdatePetRequestData::class)]
#[ResponseDataClass(class: GenericResponseData::class, responseCodes: [200, 400, 404])]
final class UpdatePetAction
{
	public function __invoke(Request $request, Response $response, array $args): Response
	{
		$data = UpdatePetRequestData::fromRequest($request);

		// Your logic here

		$result = new GenericResponseData("Pet $data->id updated.");
